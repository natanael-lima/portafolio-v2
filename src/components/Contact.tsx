...
export default function Contact({ darkMode }:ModeProps) {
  return (
    ...
    <h2 className="text-3xl font-bold mb-4 flex items-center justify-center lg:justify-start">Contact Me <BiSolidContact className='ml-2' size={32} /> </h2>
    <div className={` rounded-lg p-6  ${darkMode ? 'bg-slate-800' : 'bg-slate-300'}`}>
      ...
      <div className="space-y-2">
        <div className="flex items-center">
          <IoIosMail className="mr-2 " size={20} />
