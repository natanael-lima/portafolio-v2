    ...
    <div className="flex flex-row justify-center items-center space-x-6">
      ...
      <div className="flex items-center">
        <a
          ...
          className="p-2 rounded-lg hover:bg-neutral-300/40 dark:hover:bg-neutral-700/40 transition flex items-center text-neutral-950/80 dark:text-neutral-200"
        >
          <RiMailFill size={32} className="" />
        </a>
      </div>
