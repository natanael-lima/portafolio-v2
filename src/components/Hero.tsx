    ...
    <section id="about" className="mb-12">
      <div className="flex flex-col items-center text-center space-y-3">
        ...
        <nav className="flex items-center space-x-3 mt-6">
          ...
          >
            <RiMailFill className="transition-transform duration-200 hover:-translate-y-0 text-2xl" />
          </a>
          <a
            className="transition-colors duration-200  text-neutral-800/50   dark:text-lime-50/90 hover:text-neutral-900/60 dark:hover:text-lime-100/90 flex items-center justify-center"
            href="https://www.linkedin.com/in/natanael-ever-lima-gutierrez-9bb695259/"
            ...
            rel="noopener noreferrer"
          >
            <FaLinkedinIn className="transition-transform duration-200 hover:-translate-y-0 text-2xl" />
          </a>
          <a
            className="transition-colors duration-200 text-neutral-800/50  dark:text-lime-50/90 hover:text-neutral-900/60 dark:hover:text-lime-100/90 flex items-center justify-center"
            ...
            rel="noopener noreferrer"
          >
            <FaGithub className="transition-transform duration-200 hover:-translate-y-0 text-2xl" />
          </a>
          <a
            className="transition-colors duration-200 text-neutral-800/50  dark:text-lime-50/90 hover:text-neutral-900/60 dark:hover:text-lime-100/90 flex items-center justify-center"
            href="/resume.pdf"
          ...
          >
            <PiReadCvLogoFill className="transition-transform duration-200 hover:-translate-y-0 text-2xl" />
          </a>
        </nav>
      </div>
    </section>
